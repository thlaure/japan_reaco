...
var dict = {
  ...
  prg1_early: {
    en:
      "The first traces of population appeared back in Jomon era, period which last from 1300 to 400 BC. However, there is no evidence of human presence before Kofun Period (250-538).",
    fr:
      "Les premières traces humaines dans la région d'Hiroshima datent de l'ère Jômon, une période qui s'étend de 1300 à 400 avant J-C. Il faut toutefois remonter à la période Kofun ( env. 250-538) pour retrouver les premiers vestiges.",
    jp:
      "The first traces of population appeared back in Jomon era, period which last from 1300 to 400 BC. However, there is no evidence of human presence before Kofun Period (250-538).",
  },
  prg2_early: {
    en:
      'Hirsohima was officialy founded in 1589. The name Hiroshima means literaly "Wide island" in japenese.',
  ...
  prg3_early: {
    ...
    fr:
      "Le choix de l'emplacement de la ville est dû à son emplacement stratégique sur le delta d'Ôta.",
  ...
  prg1_sengoku: {
    en:
      'Sengoku era is full of military conflict. This period is also called "The Province in War Era".',
    fr:
      "L'époque Sengoku est marquée par de nombreux conflits militaires. On appelle également cette période l'époque des provinces en guerre.",
    jp:
      'Sengoku era is full of military conflict. This period is also called "The Province in War Era".',
  },
  prg2_sengoku: {
    en:
      "This era cover half of the Muromachi age wich is from 1336 to 1573. It's the last period before the dynasty of Tokugawa shogun takes place. It's in this age that the zen culture was born. Buildings were accompanied by those famous dry garden and the tea ceremony raised at this moment. Caractised by harmony, respect, purity and tranquility.",
    fr: `Cette époque couvre la seconde moitié de l'époque Muromachi qui s'étend de 1336 à 1573. C'est la dernière époque avant la mise en place de la dynastie des shoguns Tokugawa. C'est à cette époque que nait la culture du zen. Les constructions s'accompagnent des fameux jardins secs et la cérémonie du thé se développe. Elle se caractérise par l’harmonie, le respect, la pureté et la tranquillité.`,
    jp:
      "This era cover half of the Muromachi age wich is from 1336 to 1573. It's the last period before the dynasty of Tokugawa shogun takes place. It's in this age that the zen culture was born. Buildings were accompanied by those famous dry garden and the tea ceremony raised at this moment. Caractised by harmony, respect, purity and tranquility.",
  },
  prg3_sengoku: {
    en:
      "It's during the Sengoku Period that the West arrived on the area for exemple a portuguese ship took refuge in Japan to avoid a storm. As a result of trade exchange, cities are developed aroud harbours and internal commercial axes. Japan is also strongly developing its mining operations, mainly of gold and iron, but also its agricultural exploitation.",
    fr:
      "La période Sengoku correspond également à l'arrivée des premiers occidentaux sur le territoire et notamment un navire portugais qui s'est réfugié au Japon pour éviter une tempête. Sous l'impulsion des échanges commerciaux, les villes se développent principalement autour des ports et sur les grands axes commerciaux intérieurs. Le Japon développe aussi fortement ses exploitation minière principalement d'or et d'argent, mais aussi son exploitation agricole.",
    jp:
      "It's during the Sengoku Period that the West arrived on the area for exemple a portuguese ship took refuge in Japan to avoid a storm. As a result of trade exchange, cities are developed aroud harbours and internal commercial axes. Japan is also strongly developing its mining operations, mainly of gold and iron, but also its agricultural exploitation.",
  },
  //TIMELINE CONTENT 3//
  ...
  prg1_edo: {
    en:
      "In 1589, not so long after the begining of Edo period, Hiroshima Castle was commissioned by Mōri Terumoto, head of the powerful Mōri clan and a member of Toyotomi Hideyoshi's Council of Five Elders. In 1593, the castle was finished, Mōri Terumoto moved in.",
    fr:
      "En 1589, peu de temps avant le début de la période Edo, Mōri Terumoto, chef du puissant et respecté clan Mōri et membre du conseil des cinq anciens de Toyotomi Hideyoshi, ordonne la construction du château d’Hiroshima. En 1593, le château étant fini, Mōri Terumoto investit les lieux.",
    jp:
      "In 1589, not so long after the begining of Edo period, Hiroshima Castle was commissioned by Mōri Terumoto, head of the powerful Mōri clan and a member of Toyotomi Hideyoshi's Council of Five Elders. In 1593, the castle was finished, Mōri Terumoto moved in.",
  },
  prg2_edo: {
    en:
      'At this time, Hiroshima did not exist as entire city yet, the are was called Gokamura which means "Five Villages". Despite the change of autority on the castle, Hiroshima was a land of peace until 1869, these years of peace helped the city to grow.',
  ...
  prg3_edo: {
    en:
      "During the Meiji Restoration, Hiroshima Castle also named the Carp Castle was saved by the governement and was not one of the numerous castle being dismantled. It's turned into a military base at the end of Edo era.",
  ...
  prg1_imperial: {
    en:
      "After the Han system of estates was abolished in 1871, the city of Hiroshima became the capital of Hiroshima Prefecture. In April 1888 a new system of municipality was established. As a consequence of this, Hiroshima officially became one of the most important cities in Japan on April 1, 1889.",
  ...
  prg2_imperial: {
    en:
      "The San'yō railway was expanded in 1894, this extension was operational in the same year. A railway line was created between the main station and the port to facilitate transportation during the first Sino-Japanese war. During this war, the Japanese government temporarily moved its headquarters to Hiroshima Castle. Emperor Meiji kept his quarters at the castle from September 15, 1894 to April 27, 1895. The first exchanges between Chinese and Japanese representatives took place in Hiroshima from February 1-4, 1895.",
    fr: `Le chemin de fer San’yō fut agrandi en 1894, cette extension fut opérationnelle la même année. Une voie de chemin de fer fut créée entre la station principale et le port pour faciliter les transports durant la première guerre Sino-Japonaise. Lors de cette guerre, le gouvernement japonais déplaça temporairement son quartier général dans le château d’Hiroshima. L’empereur Meiji garda ses quartiers au château du 15 septembre 1894 au 27 avril 1895.Il faut savoir que les premiers échanges entre les représentants chinois et japonais se déroulèrent à Hiroshima du 1er au 4 février 1895.`,
    jp:
      "The San'yō railway was expanded in 1894, this extension was operational in the same year. A railway line was created between the main station and the port to facilitate transportation during the first Sino-Japanese war. During this war, the Japanese government temporarily moved its headquarters to Hiroshima Castle. Emperor Meiji kept his quarters at the castle from September 15, 1894 to April 27, 1895. The first exchanges between Chinese and Japanese representatives took place in Hiroshima from February 1-4, 1895.",
  },
  prg3_imperial: {
    en:
      "After the Sino-Japanese War, the Russo-Japanese War pushed Japan into the world of industrialization. During the First World War, Hiroshima became an important point of military activity.",
    fr:
      "Après la guerre Sino-Japonaise, la guerre Russo-Japonaise poussa le Japon dans le monde de l’industrialisation. Lors de la première guerre mondiale, Hiroshima devint un point important de l’activité militaire.",
    jp:
      "After the Sino-Japanese War, the Russo-Japanese War pushed Japan into the world of industrialization. During the First World War, Hiroshima became an important point of military activity.",
  },
  //TIMELINE CONTENT 5//
  ...
  prg2_postwar: {
    en:
      "The Hiroshima Prefectural Trade Promotion Hall, a building located 160 meters from the epicenter and having resisted the blast, becomes the A-Bomb Dome. Around the monument, the Peace Memorial Arch was inaugurated in 1954 and the Memorial Museum in 1955. A victim of war, Hiroshima has since then been the first city to become an ambassador for peace, with its city hall promoting the abolition of nuclear weapons.",
    fr:
      "Le Hall préfectoral de promotion commerciale d'Hiroshima, bâtiment situé à 160 mètres de l'épicentre et ayant résisté à la déflagration, devient le Dôme de la Bombe A. Autour du monument, le [Parc du Mémorial de la Paix](https://www.vivrelejapon.com/ville-hiroshima/parc-du-memorial-de-la-paix) est inauguré en 1954, le Musée du mémorial en 1955. Victime de la guerre, Hiroshima est depuis lors la première ville ambassadrice de la paix, sa mairie promouvant l'abolition des armes nucléaires.",
    jp:
      "The Hiroshima Prefectural Trade Promotion Hall, a building located 160 meters from the epicenter and having resisted the blast, becomes the A-Bomb Dome. Around the monument, the Peace Memorial Arch was inaugurated in 1954 and the Memorial Museum in 1955. A victim of war, Hiroshima has since then been the first city to become an ambassador for peace, with its city hall promoting the abolition of nuclear weapons.",
  },
  prg3_postwar: {
    en:
      'In November 2010 at the Hiroshima Summit, the Dalai Lama and five other prize winners attended the Nobel Peace Prize Summit. The summit was dedicated to nuclear disarmament and held in Hiroshima. Hiroshima too has changed. The "calcined plain" is now a forward-looking city of 1.2 million inhabitants, as the new Orizuru Tower inaugurated in the summer of 2016. A city resolutely committed to its role as world capital of peace',
    fr: `En novembre 2010 lors du sommet d'Hiroshima, le [Dalaï-lama](https://fr.wikipedia.org/wiki/Dala%C3%AF-lama) et cinq autres lauréats du prix ont participé au sommet des [prix Nobel de la Paix](https://fr.wikipedia.org/wiki/Prix_Nobel_de_la_Paix). Ce sommet était consacré au désarmement nucléaire et organisé à Hiroshima.
    Hiroshima aussi a changé. La "plaine calcinée" est aujourd'hui une ville de 1,2 million d'habitants, tournée vers l'avenir, à l'image de la nouvelle [Tour Orizuru](https://www.vivrelejapon.com/ville-hiroshima/orizuru-tower) inaugurée à l'été 2016. Une ville résolument engagée dans son rôle de capitale mondiale de la paix.`,
    jp:
      'In November 2010 at the Hiroshima Summit, the Dalai Lama and five other prize winners attended the Nobel Peace Prize Summit. The summit was dedicated to nuclear disarmament and held in Hiroshima. Hiroshima too has changed. The "calcined plain" is now a forward-looking city of 1.2 million inhabitants, as the new Orizuru Tower inaugurated in the summer of 2016. A city resolutely committed to its role as world capital of peace',
  },
  ar_title: {
  ...
  footer: {
    en:
      "Developed by CNAM students in collaboration with Ingemedia students, french schools",
    fr:
      "Développé par les étudiants du cnam en collaboration avec les étudiants d'Ingémédia, écoles françaises",
    jp:
      "Developed by CNAM students in collaboration with Ingemedia students, french schools",
  },
};
